...
interface CanvasCaptureMediaStreamTrack extends MediaStreamTrack {
  ...
  addEventListener<K extends keyof MediaStreamTrackEventMap>(
    type: K,
    listener: (this: CanvasCaptureMediaStreamTrack, ev: MediaStreamTrackEventMap[K]) => any,
    options?: boolean | AddEventListenerOptions,
  ): void;
  addEventListener(
    type: string,
...
interface ServiceWorkerRegistration extends EventTarget {
  ...
  subscribeToResponse(title: string, options?: NotificationOptions): Promise<void>;
