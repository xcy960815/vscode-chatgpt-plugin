    ...
    function f(e, n, i, r) {
      ...
      function b(e, n) {
        return (
          ...
          e.beginScope &&
            (e.beginScope._wrap
              ? (M.addKeyword(S, w.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap),
                (S = ''))
    ...
    function y(e) {
      ...
      const t = ((e) => {
        ...
        if (t) {
          ...
          return (
            n ||
              (H(o.replace('{}', t[1])), H('Falling back to no-highlight mode for this block.', e)),
            n ? t[1] : 'no-highlight'
          );
        }
        ...
        x = [
          {
            ...
            className: 'keyword',
            starts: {
              contains: [{ begin: /\(/, end: /\)/, keywords: Fe, contains: [...b, h, v] }],
            },
          },
